...
<template>
  <div class="article-share-container">
    <!-- ប្តូរប្រអប់នេះឱ្យទៅជាជួរឈរ (Column) -->
...
/* ប្រអប់ពណ៌សរាងមូលបញ្ឈរ (Column Pill Container) */
.share-pill-box {
  display: flex;
  flex-direction: column; /* ប្តូរពីជួរដេកមកជួរឈរវិញ */
  align-items: center;
  gap: 10px;
  background-color: #ffffff;
  padding: 8px 4px;       /* កែប្រែ Padding ឲ្យសមល្មមជាមួយទម្រង់បញ្ឈរ */
  border-radius: 50px;
  box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08);
  border: 1px solid #cbd5e1;
}

/* ការកំណត់រចនាប័ទុប៊ូតុងទូទៅ */
.share-btn {
  border: none;
  width: 42px;
  height: 42px;
