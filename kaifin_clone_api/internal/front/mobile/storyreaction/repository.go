...
type StoryReactionMobileRepo interface {
...
type StoryReactionMobileRepoImpl struct {
	dbpool *sqlx.DB
}

func NewStoryReactionMobileRepoImpl(db *sqlx.DB) *StoryReactionMobileRepoImpl {
	return &StoryReactionMobileRepoImpl{
		dbpool: db,
	}
}

func (r *StoryReactionMobileRepoImpl) Upsert(req *CreateStoryReactionRequest, uctx *share.UserContext) (*StoryReaction, *error_responses.ErrorResponse) {
...
func (r *StoryReactionMobileRepoImpl) Show(req ShowStoryReactionRequest) (*StoryReactionResponse, *error_responses.ErrorResponse) {
	msg := error_responses.ErrorResponse{}
...
func (r *StoryReactionMobileRepoImpl) Delete(storyID int64, userID int64) *error_responses.ErrorResponse {
	msg := error_responses.ErrorResponse{}
