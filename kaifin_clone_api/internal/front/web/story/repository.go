...
func NewStoryRepoImpl(db *sqlx.DB) *StoryRepoImpl {
	return &StoryRepoImpl{
		dbpool: db,
	}
}

func (r *StoryRepoImpl) Create(req *CreateStoryRequest, uctx *share.UserContext) *error_responses.ErrorResponse {
...
func (r *StoryRepoImpl) Show(req ShowStoryRequest) (*StoryResponse, *error_responses.ErrorResponse) {
	msg := error_responses.ErrorResponse{}
...
func (r *StoryRepoImpl) Delete(id int64, userID int64) *error_responses.ErrorResponse {
	msg := error_responses.ErrorResponse{}
