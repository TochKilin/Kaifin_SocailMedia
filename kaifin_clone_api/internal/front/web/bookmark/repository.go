...
func NewBookMarkRepoImpl(db *sqlx.DB) *BookMarkRepoImpl {
	return &BookMarkRepoImpl{
		dbpool: db,
	}
}

func (r *BookMarkRepoImpl) ToggleBookmark(userID, postID int64) (bool, *error_responses.ErrorResponse) {
...
func (r *BookMarkRepoImpl) CountByPost(postID int64) (int64, *error_responses.ErrorResponse) {
	msg := error_responses.ErrorResponse{}
	var count int64
...
func (r *BookMarkRepoImpl) Show(userID int64, req ShowBookmarkRequest) (*BookmarkResponse, *error_responses.ErrorResponse) {
	msg := error_responses.ErrorResponse{}
